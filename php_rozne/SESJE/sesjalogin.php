...
mysql_connect("localhost", "root", "")or die("Nie mo¿na nawi¹zaæ po³¹czenia z baz¹");
...
function ShowLogin($komunikat=""){
	...
	echo "</form>";
	echo "Jeœli nie jesteœ zarejestrowany, <a href='rejestruj.php'>tu znajdziesz formularz</a>";
}
...
<body>
<?php
if($_GET["wyloguj"]=="tak"){$_SESSION["count"]=0;echo "Zosta³eœ wylogowany z serwisu";}
if($_SESSION["count"]!=1){
